...
function NavBar() {
    ...
    const [colorNavBar, setColorNavBar] = useState("bg-[#E5E5E5]");
            ...
            <div className={"fixed w-full z-50 " + colorNavBar}>
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div className="items-center justify-between w-full md:flex md:w-auto md:order-1" hidden={!showHamburger} id="navbar-search">
                        <ul style={{ backgroundColor: "transparent" }} className="flex bg-tr flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-[#E5E5E5] md:dark:bg-[#E5E5E5] dark:border-gray-700">
                            <li>
                                <Link
                                    href="/home"
                                    className={"block py-2 px-3 text-[#445964]  rounded md:bg-[#E5E5E5] md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500" + linkSelected("home")}
                                    onClick={() => {
                                        setLinkCurrent("/home");
                                        setShowHamburguer(false);
                                    }}>
                            ...
                            <li>
                                <Link
                                    href="/sobre"
                                    className={"block py-2 px-3 text-[#445964]  rounded md:bg-[#E5E5E5] md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500" + linkSelected("sobre")}
                                    onClick={() => {
                            ...
                            <li>
                                <Link
                                    href="#"
                                    className={"block py-2 px-3 text-[#445964]  rounded md:bg-[#E5E5E5] md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500" + linkSelected("contato")}
                                    onClick={() => {
                                        setShowModal(true)
                                        setShowHamburguer(false);
                                    }}>contato</Link>
